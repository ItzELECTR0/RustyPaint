...
about-report = Report a problem or ask for a feature
...
colour = Color
add-colour = +  Add color
edit = Edit
remove = Remove
picker-title = Choose a new color
picker-red = Red
picker-green = Green
picker-blue = Blue
picker-alpha = Alpha
...
resampling-nearest = Nearest neighbor
unit-pixels = Pixels
