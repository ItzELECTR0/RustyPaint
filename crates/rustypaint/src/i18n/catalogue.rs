...
catalogue! {
    plain {
        ...
        settings_cutout => "settings-cutout",
        settings_cutout_note => "settings-cutout-note",
        settings_cutout_recognition => "settings-cutout-recognition",
        settings_cutout_recognition_note => "settings-cutout-recognition-note",
        settings_cutout_model => "settings-cutout-model",
        settings_cutout_bundled => "settings-cutout-bundled",
        settings_cutout_folder => "settings-cutout-folder",
        settings_cutout_choose => "settings-cutout-choose",
        settings_cutout_model_note => "settings-cutout-model-note",
        ...
        accent_custom => "accent-custom",
        settings_accent_fill => "settings-accent-fill",
        settings_gradient_from => "settings-gradient-from",
        settings_gradient_to => "settings-gradient-to",
        ...
        add_image => "add-image",
        blur_box => "blur-box",
        blur_algorithm => "blur-algorithm",
        blur_algorithm_box => "blur-algorithm-box",
        blur_algorithm_gaussian => "blur-algorithm-gaussian",
        blur_algorithm_median => "blur-algorithm-median",
        blur_algorithm_motion => "blur-algorithm-motion",
        blur_algorithm_bilateral => "blur-algorithm-bilateral",
        blur_algorithm_directional => "blur-algorithm-directional",
        blur_algorithm_defocus => "blur-algorithm-defocus",
        blur_algorithm_kawase => "blur-algorithm-kawase",
        blur_strength => "blur-strength",
        blur_radius => "blur-radius",
        blur_distance => "blur-distance",
        blur_angle => "blur-angle",
        blur_edge_preservation => "blur-edge-preservation",
        blur_directionality => "blur-directionality",
        blur_passes => "blur-passes",
        blur_blades => "blur-blades",
        blur_rotation => "blur-rotation",
        blur_hint => "blur-hint",
        ...
        resampling_smooth => "resampling-smooth",
        ...
        cutout_target => "cutout-target",
        cutout_subject => "cutout-subject",
        cutout_background => "cutout-background",
        cutout_colour => "cutout-colour",
        cutout_colour_hint => "cutout-colour-hint",
        cutout_target_hint => "cutout-target-hint",
        ...
        cutout_licences => "cutout-licences",
        cutout_decontaminate => "cutout-decontaminate",
        cutout_edges => "cutout-edges",
        cutout_options => "cutout-options",
        cutout_radius => "cutout-radius",
        cutout_brush_radius => "cutout-brush-radius",
        cutout_fallback => "cutout-fallback",
        cutout_feather => "cutout-feather",
        cutout_smooth => "cutout-smooth",
        cutout_shift => "cutout-shift",
        cutout_preview => "cutout-preview",
        cutout_overlay => "cutout-overlay",
        cutout_checkerboard => "cutout-checkerboard",
        cutout_working => "cutout-working",
        cutout_failed => "cutout-failed",
        cutout_undo_hint => "cutout-undo-hint",
